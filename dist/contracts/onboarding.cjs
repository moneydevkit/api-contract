...
__export(onboarding_exports, {
  ...
  pollDeviceAuthContract: () => pollDeviceAuthContract,
  startDeviceAuthContract: () => startDeviceAuthContract
});
...
// src/contracts/onboarding.ts
var startDeviceAuthContract = import_contract.oc.input(StartDeviceAuthInputSchema).output(StartDeviceAuthOutputSchema);
var pollDeviceAuthContract = import_contract.oc.input(PollDeviceAuthInputSchema).output(PollDeviceAuthOutputSchema);
var bootstrapContract = import_contract.oc.input(BootstrapInputSchema).output(BootstrapOutputSchema);
var onboarding = {
